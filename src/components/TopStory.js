...
function TopStory() {
  return (
    <div>
      ...
      <div className='headline md:flex mt-4 cursor-pointer border-b border-gray-300 pb-4' onClick={() => {window.open('https://www.webmd.com/balance/ss/slideshow-holiday-travel-less-stressful', "_blank");}}>
